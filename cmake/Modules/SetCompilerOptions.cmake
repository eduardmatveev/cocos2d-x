macro (SetCompilerOptions)
	...
	if(MSVC)
      ...
      set(CMAKE_C_FLAGS_DEBUG "-g -DCOCOS2D_DEBUG=1")
      set(CMAKE_C_FLAGS_RELEASE "-DCOCOS2D_DEBUG=0 -O3")
	  set(CMAKE_CXX_FLAGS_DEBUG ${CMAKE_C_FLAGS_DEBUG})
	  set(CMAKE_CXX_FLAGS_RELEASE ${CMAKE_C_FLAGS_DEBUG})
	  set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -std=gnu99 -Wno-all -Wno-attributes")
	  set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -std=c++11 -Wno-deprecated-declarations -Wno-reorder -Wno-all -Wno-attributes")
	  if(CLANG)
